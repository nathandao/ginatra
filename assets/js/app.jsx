...
$(function(){
  React.render(
    <CommitsOverview url='/stat/commits_overview?from=today%20at%200:00&til=now' interval='600000' width='500' height='500' />,
    document.getElementById("today-overview")
  );

  React.render(
    <SprintOverview interval='600000' width='500' height='180' />,
    document.getElementById("sprint-overview")
  );

  React.render(
    <RepoTable interval='600000' url='/stat/repo_list' />,
    document.getElementById("repo-info")
  );

  React.render(
    <GinatraChart type="Doughnut" url="/stat/chart/round/lines" interval="600000" options='{ scaleBackdropColor : "rgba(255,255,255,1)" }' />,
    document.getElementById("project-size-comparison")
  );

  React.render(
    <TodayActivity interval="600000" width="500" height="300" />,
